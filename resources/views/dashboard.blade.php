    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <dl class="grid max-w-screen-xl grid-cols-3 gap-8 p-4 mx-auto text-gray-900 sm:grid-cols-3 xl:grid-cols-6 dark:text-white sm:p-8">
                    <div class="flex flex-col items-center justify-center text-red-800">
                        ...
                        <dd class="text-gray-500 dark:text-gray-400">Total Pagar</dd>
                    </div>
                    <div class="flex flex-col items-center justify-center text-red-800">
                        <dt class="mb-2 text-3xl font-extrabold">R$ {{number_format($saldos['total_receber'],2,',','.')}}</dt>
                        <dd class="text-gray-500 dark:text-gray-400">Total Receber</dd>
                    </div>
                    <div class="flex flex-col items-center justify-center text-red-800">
                        <dt class="mb-2 text-3xl font-extrabold">R$ {{number_format($saldos['saldo'],2,',','.')}}</dt>
                        <dd class="text-gray-500 dark:text-gray-400">Saldo</dd>
                    </div>
                </dl>    
