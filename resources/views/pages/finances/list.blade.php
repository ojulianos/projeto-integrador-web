            ...
            <tr class=" hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <td class="p-4 text-left font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <button 
                        ...
                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black bg-green-600 rounded-lg hover:bg-green-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
