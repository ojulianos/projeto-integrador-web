<x-app-layout>
    ...
    <div class="p-4">
        <form class="flex flex-wrap items-end space-x-4">
            ...
            <div class="flex-1">
                <label for="date_emission_initial" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Data Emissao Inicio</label>
                <input type="date"
                id="date_emission_initial"
                class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                value="{{ $finance->date_emission ?? '' }}"
                name="date_emission_initial"
            />
            </div>
    
            <div class="flex-1">
                <label for="date_emission_final" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Data Emissao Fim</label>
                <input type="date"
                id="date_emission_final"
                class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                value="{{ $finance->date_emission ?? '' }}"
                name="date_emission_final"
            />
            </div>
        ...
        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
            ...
            <tr class=" hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <td class="p-4 text-left font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    <x-custom.edit-button :functionName="'formFinance'" :itemId=$finance />
                    <x-custom.delete-button :functionName="'deleteFinance'" :itemId=$finance />
                </td>
            </tr>
            @endforeach
        </tbody>
